                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">
                            <i class="fas fa-plus-circle me-2"></i>Edit Product
                        </h4>
                    </div>
                    <div class="card-body">
                        <form id="productForm" action="{{ url('admin/categories/'.$category->id) }}" method="POST" enctype="multipart/form-data">
                            @method('put')
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="2" <?php if($category->status == 2){ echo 'selected'; } ?>>Inctive</option>
